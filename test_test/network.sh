...
export FABRIC_CFG_PATH=${PWD}/configtx  #настроить
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_orderer.service.ru docker_peer0.org1.service.ru docker_peer0.org2.service.ru
